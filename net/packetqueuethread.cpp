...
// 构造
PacketQueueThread::PacketQueueThread() : sys::CDefaultRunnable() {
_stop = 0;
_waitFinish = false;
_handler = NULL;
_args = NULL;
...
_speed_t2 = sys::CTimeUtil::getTime();
