...
#define PROFILER_START(s) do { if(sys::util::Profiler::m_profiler.status == 1) sys::util::Profiler::m_profiler.start((s)); } while(0)
#define PROFILER_STOP() do { if(sys::util::Profiler::m_profiler.status == 1) sys::util::Profiler::m_profiler.reset(); } while (0)
#define PROFILER_BEGIN(s) do { if(sys::util::Profiler::m_profiler.status == 1) sys::util::Profiler::m_profiler.begin((s)); } while(0)
#define PROFILER_END() do { if(sys::util::Profiler::m_profiler.status == 1) sys::util::Profiler::m_profiler.end(); } while(0)
#define PROFILER_DUMP() do { if(sys::util::Profiler::m_profiler.status == 1) sys::util::Profiler::m_profiler.dump(); } while(0)
#define PROFILER_SET_THRESHOLD(sh) sys::util::Profiler::m_profiler.threshold = (sh)
#define PROFILER_SET_STATUS(st) sys::util::Profiler::m_profiler.status = (st)
